                ...
                <div class="card card-primary w-100 h-100">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="inputKodeCustomer" name="kode_customer" class="form-control @error('kode_customer') is-invalid @enderror" placeholder="Masukkan Kode Pelanggan" value="{{ $customer->kode_customer }}" required autocomplete="kode_customer">
                            @error('kode_customer')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="inputNamaCustomer" name="nama_customer" class="form-control @error('nama_customer') is-invalid @enderror" placeholder="Masukkan Nama Pelanggan" value="{{ $customer->nama_customer }}" required autocomplete="nama_customer">
                            @error('nama_customer')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
