                ...
                <div class="card card-primary w-100 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nama_customer" name="nama_customer" class="form-control @error('nama_customer') is-invalid @enderror" placeholder="Masukkan Nama Pelanggan" value="{{ old('nama_customer') }}" required>
                            @error('nama_customer')
